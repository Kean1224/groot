...
:: Delete markdown documentation files (keep README.md)
...
:: Delete script files (no longer needed)
...
:: Delete backend markdown files
del /f /q "backend\*.md" 2>nul

echo Cleanup complete!
echo Kept: README.md, package.json, render.yaml, .gitignore
pause
